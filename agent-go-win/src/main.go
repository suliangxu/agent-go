...
func ProcessCongfigPath()  {
	...
	os.Mkdir(configure.ProjectPath+"/newTempDir", 777)
	os.Mkdir(configure.ProjectPath+"/script", 777)
...
func setPath()  {
	configure.ScriptsPath = configure.ProjectPath + "/script"
...
func main()  {
	...
	configure.UninstallProjectSignal = false
